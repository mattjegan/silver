...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='invoice',
            name='proforma',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='related_invoice', blank=True, to='silver.Proforma', null=True),
        ),
        migrations.AlterField(
            model_name='plan',
            name='currency',
        ...
        migrations.AlterField(
            model_name='proforma',
            name='invoice',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='related_proforma', blank=True, to='silver.Invoice', null=True),
        ),
        migrations.AlterField(
            model_name='provider',
            name='country',
        ...
        migrations.AddField(
            ...
            name='invoice',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, blank=True, to='silver.Invoice', null=True),
        ),
        migrations.AddField(
            model_name='transaction',
            name='payment_method',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='silver.PaymentMethod'),
        ),
        migrations.AddField(
            model_name='transaction',
            name='proforma',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, blank=True, to='silver.Proforma', null=True),
        ),
        migrations.AddField(
