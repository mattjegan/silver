...
class TestDocumentEndpoints(APITestCase):
    ...
    def _get_expected_data(self, document, transactions=None):
        ...
        return {
            ...
            u'due_date': repr(document.due_date) if document.due_date else None,
            u'issue_date': repr(document.issue_date) if document.issue_date else None,
